...
const Movie = (props) => {
    ...
    const { onErrImg } = props
    
    return (
        <div className="col-lg-3">
            <div className="card">
                <div className="poster-container">
                    <img className="card-img-top" src={Poster || ''} alt="Movie Poster" onError={onErrImg} />
                </div>
                ...
                <div className="card-body">
                    ...
                    <small><i className="fas fa-bookmark icon-space" title="Genre"></i>{Genre}</small>
                </div>
